...
% Attention: si y est axe de sym�trie les fonctions sont symetriques ou antisymetriques en x
%
%                                                Ex    Ey    Ez   Hx   Hy   Hz
...
% nota:  les elements de si de 5 a 8 ne sont utilis�s que par retbrillouin
%
...
r_num=[r_num,r_num(end)+(r_phys(end)-r_phys(end-1))/Pml{2}(1)];% prolongement jusqu'� r0 avec la pente Pml{2}(1)
...
% nota:  les elements de si de 5 � 8 ne sont utilis�s que par retbrillouin
end
parm.nsym=n;
