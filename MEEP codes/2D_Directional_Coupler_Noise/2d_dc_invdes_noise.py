...
if __name__ == '__main__':
    ...
    parser.add_argument('-mean', type=float, default=0.0, help='mean for the random noise in the initial design')
    parser.add_argument('-std', type=float, default=0.1, help='standard deviation for the random noise in the initial designr')
